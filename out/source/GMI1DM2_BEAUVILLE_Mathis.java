...
public void litSommet(BufferedReader fichier) {
  try {
    ...
    if (newSommet) {
      ...
      coordSommet[nbSommet][1] = PApplet.parseInt(reader.readLine());
    }
    coordSommet[nbSommet][2] = PApplet.parseInt(reader.readLine());
    coordSommet[nbSommet][3] = PApplet.parseInt(reader.readLine());
...
public void litArete(BufferedReader fichier) {
  try {
    ...
    coordArete[nbArete][1] = PApplet.parseInt(reader.readLine());
    coordArete[nbArete][2] = PApplet.parseInt(reader.readLine());
    coordArete[nbArete][3] = PApplet.parseInt(reader.readLine());
    coordArete[nbArete][4] = PApplet.parseInt(reader.readLine());
    coordArete[nbArete][5] = PApplet.parseInt(reader.readLine());
    reader.readLine(); // Ferme la balise
...
public void litEtAfficheFace(BufferedReader fichier) {
  try {
    ...
    for (int i = 0; i < coordFace[nbFace][1]*2; ++i) {
      coordFace[nbFace][2+i] = PApplet.parseInt(reader.readLine());
    }
